...
{
  HW_Set_IO_InputFloat(KEYBOARD_SCAN0_PORT, KEYBOARD_SCAN0_PIN);
  HW_Set_IO_InputFloat(KEYBOARD_SCAN1_PORT, KEYBOARD_SCAN1_PIN);	
  HW_Set_IO_InputFloat(KEYBOARD_SCAN2_PORT, KEYBOARD_SCAN2_PIN);
  HW_Set_IO_InputFloat(KEYBOARD_SCAN3_PORT, KEYBOARD_SCAN3_PIN);		
  HW_Set_IO_InputFloat(KEYBOARD_SCAN4_PORT, KEYBOARD_SCAN4_PIN);
  HW_Set_IO_InputFloat(KEYBOARD_SCAN5_PORT, KEYBOARD_SCAN5_PIN);
  HW_Set_IO_InputFloat(KEYBOARD_SCAN6_PORT, KEYBOARD_SCAN6_PIN);
  HW_Set_IO_InputFloat(KEYBOARD_SCAN7_PORT, KEYBOARD_SCAN7_PIN);
